    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_verification_token', models.UUIDField(default=uuid.uuid4, editable=False, verbose_name='メール認証トークン')),
                ('email_verification_token_created_at', models.DateTimeField(blank=True, null=True, verbose_name='メール認証トークン作成日時')),
